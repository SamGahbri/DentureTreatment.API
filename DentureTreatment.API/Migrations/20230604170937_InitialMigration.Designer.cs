...
namespace DentureTreatment.API.Migrations
{
    ...
    [Migration("20230604170937_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentureTreatment.API.Entities_D.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DentureTreatment.API.Entities_D.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DentureTreatment.API.Entities_D.Book", b =>
                {
                    b.HasOne("DentureTreatment.API.Entities_D.Author", "Author")
                        .WithMany()
